...
// 비는 현상 실측(P1 run2). 통화에서 벙어리는 치명적이므로 minimal로 눌러
// 예산을 답변 텍스트에 쓴다. 환경변수로 조정 가능. (w2-spec S4 필수 항목)
...
export const TTS_MODEL = "gpt-4o-mini-tts"; // 문장 단위 TTS(HTTP), mp3
export const TTS_VOICE = process.env.TTS_VOICE ?? "marin"; // 필립 톤 후보 marin/cedar
